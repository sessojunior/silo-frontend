...
export default function UserSelectorOffcanvas({ isOpen, onClose, group, onSuccess }: UserSelectorOffcanvasProps) {
		...
		try {
			...
			if (allSuccessful) {
				...
				toast({
					...
					description: 'Alguns usuários não foram adicionados. Tente novamente.',
				})
			}
		} catch (error) {
	...
	return (
		<div className='fixed inset-0 z-50'>
			...
			{/* Offcanvas */}
			<div className='fixed right-0 top-0 h-full w-full max-w-md bg-white dark:bg-zinc-900 shadow-xl transform transition-transform'>
				{/* Header */}
