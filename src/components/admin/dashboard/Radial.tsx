...
export default function Radial({ name, progress, color, colorDark }: { name: string; progress: number; color: string; colorDark: string }) {
	return (
		<div className='flex flex-col items-center justify-center gap-1.5 px-2 py-6'>
