...
// 3. Em URIs de redirecionamento autorizados, adicione a seguinte URL: 'http://localhost:3000/api/auth/callback/google' (se estiver em ambiente de desenvolvimento) ou a URL de produção configurada na variável GOOGLE_CALLBACK_URL.
