		...
		<footer className='flex h-16 justify-between border-t border-t-transparent'>
			<div className='flex w-full items-center justify-between gap-2 px-4'>
				<div className='flex items-center gap-2'>
					<Image src={user.image ? `/uploads/profile/${user.id}.png` : '/images/profile.png'} alt='Avatar' width={40} height={40} className='inline-block size-[40px] rounded-full' />
