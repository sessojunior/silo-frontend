					...
					<div className='flex flex-col sm:flex-row gap-4 justify-between items-start sm:items-center'>
						<div className='flex flex-col sm:flex-row gap-3 flex-1'>
							...
							<div className='relative flex-1 min-w-80 max-w-md'>
								<Input type='text' placeholder='Buscar produtos...' value={search} setValue={setSearch} className='pl-10' />
									...
									<tbody className='bg-white dark:bg-zinc-900 divide-y divide-zinc-200 dark:divide-zinc-700'>
										{filteredProducts.map((product) => (
											<tr key={product.id} className='hover:bg-zinc-50 dark:hover:bg-zinc-800/50'>
												...
												<td className='px-6 py-4 whitespace-nowrap'>
													<div className='text-sm text-zinc-600 dark:text-zinc-400 font-mono'>{product.slug}</div>
												</td>
												<td className='px-6 py-4 whitespace-nowrap'>
