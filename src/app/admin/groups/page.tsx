	...
	return (
		<div className='min-h-screen w-full'>
			...
			<div className='p-6 border-b border-zinc-200 dark:border-zinc-700'>
				<h1 className='text-2xl font-bold text-zinc-900 dark:text-zinc-100'>Grupos e Usuários</h1>
				<p className='text-zinc-600 dark:text-zinc-400 mt-1'>Gerencie grupos de usuários do sistema para organização e futuro chat interno</p>
			</div>
