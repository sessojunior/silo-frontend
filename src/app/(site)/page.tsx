		...
		<div className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden before:absolute before:start-1/2 before:top-0 before:-z-1 before:size-full before:-translate-x-1/2 before:transform before:bg-[url('/images/background-home.svg')] before:bg-cover before:bg-top before:bg-no-repeat">
			<div className='mx-auto max-w-[85rem] px-4 pt-24 pb-10 sm:px-6 lg:px-8'>
				...
				<div className='flex justify-center'>
					<a href='/register' className='group inline-flex items-center gap-x-2 rounded-full border border-zinc-200 bg-white p-1 ps-3 text-sm text-zinc-800 transition hover:border-zinc-400 focus:border-zinc-300 focus:outline-hidden'>
				...
				<div className='mt-8 flex justify-center gap-3'>
					<a href='/login' className='inline-flex items-center justify-center gap-x-3 rounded-md border border-transparent bg-linear-to-tl from-blue-600 to-violet-600 px-4 py-3 text-center text-base font-medium text-white hover:from-violet-600 hover:to-blue-600 focus:from-violet-600 focus:to-blue-600 focus:outline-hidden'>
