 ...
 */
export async function optimizeImage(buffer, filename, type = 'general') {
    try {
 ...
 */
export async function generateProfileImage(buffer, userId) {
    try {
 ...
 */
export function cleanupOldFiles(dirPath, extension) {
    try {
        if (!fs.existsSync(dirPath)) {
            return;
        }
